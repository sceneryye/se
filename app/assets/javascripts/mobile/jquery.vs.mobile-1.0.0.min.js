        ...
        var a = $("#cart_list"),
            ...
            f = {
                show: function() {
                    ...
                    "" != a.istempuser && !isNaN(a.istempuser) && a.istempuser ? VsmCart.VsmDialog('<p style="text-align:center;display:block;">如有账号，点击登录！</p>', {
                        ...
                        onDoComplete: function(a, b) {
                            b.oncomplete(!1),
                                self.location.href = "user-login.html"
                        },
                        onDoCompleteTo: function(a, b) {
                            b.oncomplete(!1),
                                self.location.href = "cart-edit-receive-massage.html"
                        }
                ...
                register: function() {
                    ...
                    if (!a.tiggerIsEmpty(d.consignee.val()) && "" == d.consignee.val()) return VsmwebForm.erBlackDialog("请填写收货人姓名"),
                        d.consignee.focus(),
                        VmPageEffect.sharkError(d.consignee.parent().parent(), "ui-note-error", !1, 0, 5, 50),
                        !1;
                    if (a.tiggerIsEmpty(d.consignee.val()) && !VsmwebForm.dataType.c.test($.trim(d.consignee.val()))) return VsmwebForm.erBlackDialog("请填写1~8位中文姓名"),
                        d.consignee.focus(),
                        VmPageEffect.sharkError(d.consignee.parent().parent(), "ui-note-error", !1, 0, 5, 50),
                        !1;
                    if (!a.tiggerIsEmpty(d.mobile.val()) && "" == d.mobile.val()) return VsmwebForm.erBlackDialog("手机号码不能为空"),
                        d.mobile.focus(),
                        VmPageEffect.sharkError(d.mobile.parent().parent(), "ui-note-error", !1, 0, 5, 50),
                        !1;
                    if (a.tiggerIsEmpty(d.mobile.val()) && !VsmwebForm.dataType.m.test($.trim(d.mobile.val()))) return VsmwebForm.erBlackDialog("手机号码格式错误"),
                        d.mobile.focus(),
                        VmPageEffect.sharkError(d.mobile.parent().parent(), "ui-note-error", !1, 0, 5, 50),
                        !1;
                    if (!a.tiggerIsEmpty(d.captcha.val()) && "" == d.captcha.val()) return VsmwebForm.erBlackDialog("请输入验证码"),
                        d.captcha.focus(),
                        VmPageEffect.sharkError(d.captcha.parent(), "ui-note-error", !1, 0, 5, 50),
                        !1;
                    var e = {
                ...
                setPassWord: function() {
                    ...
                    if (!a.tiggerIsEmpty(d.psw.val()) && "" == d.psw.val()) return VsmwebForm.erBlackDialog("请输入密码"),
                        d.psw.focus(),
                        VmPageEffect.sharkError(d.psw.parent(), "ui-note-error", !1, 0, 5, 50),
                        !1;
                    if (a.tiggerIsEmpty(d.psw.val()) && (d.psw.val().length < 6 || d.psw.val().length > 20)) return VsmwebForm.erBlackDialog("请输入6-20位密码"),
                        d.psw.focus(),
                        VmPageEffect.sharkError(d.psw.parent(), "ui-note-error", !1, 0, 5, 50),
                        !1;
                    if (!isNaN(d.psw.val()) || "-1" != d.psw.val().search(VsmwebForm.dataType.s)) return VsmwebForm.erBlackDialog("请使用字母和数字组合"),
                        d.psw.focus(),
                        !1;
                    var e = {
                ...
                jumpLinks: function() {
                    ...
                    dom = {
                        ...
                        onDoCompleteTo: function(a, b) {
                            b.oncomplete(!1),
                                self.location.href = location.href + "&mtp=1"
                        }
                    })
                }
            },
                    ...
                    var a = $('[data-countTemporary="true"]'),
                        b = {
                            ...
                            onEndComplete: function() {
                                this.children().html("00:00"),
                                    VsmCart.VsmDialog('<p style="text-align:center;">购物车超时了<br />请重新选购商品</p>', {
                                        title: "友情提醒您",
                                        setClass: "ui-modal-btn-c",
                                        overClose: !1,
                                        buttons: !0,
            ...
            i = {
                bindEvents: function() {
                    a.off("click.login.dialog", '[data-islogin="true"]').on("click.login.dialog", '[data-islogin="true"]', f.show),
                        b.off("click.registe.check").on("click.registe.check", f.register),
                        e.off("click.password.set").on("click.password.set", f.setPassWord),
                        d.off("click.jump.psw").on("click.jump.psw", f.jumpLinks)
                }
            },
            j = {
                init: function() {
                    i.bindEvents(),
                        c.length && g.countdown(),
                        e.length && h.init()
                }
            };
        return {
        ...
        p = {
            bindEvents: function() {
                a.off("click.asyn.loading").on("click.asyn.loading", k.getBrandinit),
                    ...
                    i.children().filter("h3,p").off("click.accordion.down").on("click.accordion.down", k.tiggerAccordionInit)
            },
            init: function() {
                p.bindEvents(),
    ...
    var a,
                ...
                "string" == typeof h.time && (h.time = parseInt(h.time, 10)),
                    ...
                    function k() {
                        ...
                        i.nowTime = i.nowTime + h.interval / 1e3,
                            ...
                            h.timeWarn && 300 === sec && !$('[data-OrderFrom="true"]').length && g('您的购物车只剩 <span class="fontred">5分钟</span> 时间，立即结算？', {
                            title: "友情提醒您",
                            buttons: !0,
                            type: "confirm",
        ...
        f = {
            ...
            init: function() {
                ...
                c.Init = function() {
                    var b,
                        d = isNaN(d) ? e.width: parseInt(e.width, 10);
                        ...
                        if (n && (c.footer = $("<div>", {
                            ...
                            function(a, b) {
                                if ("object" == typeof b) {
                                    ...
                                    "boolean" != typeof d.data("dismiss") || d.data("dismiss") ? "boolean" == typeof d.data("dismiss") && d.data("dismiss") ? (2 === e.buttonsPos && d.addClass(e.buttonsStyle), d.off("click.modal.close").on("click.modal.close",
                                        function() {
                                        ...
                                        })) : (e.buttonsPos > 2 && d.addClass(e.buttonsStyle), d.off("click.modal.close").on("click.modal.close",
                                        function() {
                                            c.close()
                                        })) : (1 === e.buttonsPos && d.addClass(e.buttonsStyle), d.off("click.modal.close").on("click.modal.close",
                                        function() {
                                            e.onDoComplete && "function" == typeof e.onDoComplete && e.onDoComplete($(this), {
                                                oncomplete: function(a) {
                                                    a ? c.close($(this), a.toString()) : c.close()
        ...
        v = {
            ...
            BindBrowserEvents: function() {
                ...
                var a = Cookie.Browser(),
                    b = $("<div />", {
                        "class": "ui-top-note"
                    }); (void 0 == Cookie.Get("m_id") || "undefined" == Cookie.Get("m_id") || "" == Cookie.Get("m_id")) && (0 != a.isSafari && "" != a.isSafari ? $(b).text("浏览器cookie被禁用，为了不影响您购物，请去设置中开启cookie！").prependTo("body") : $(b).text("浏览器cookie被禁用，为了不影响您购物，请去浏览器设置中开启cookie！").prependTo("body"))
                    */
            }
        },
        w = {
